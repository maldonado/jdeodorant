...
public class Standalone {
	...
	public static List<MoveMethodCandidateRefactoring> getMoveMethodRefactoringOpportunities(IJavaProject project, ClassObject classObject) {
...
//		}
	...
	public static Set<ExtractClassCandidateGroup> getExtractClassRefactoringOpportunities(IJavaProject project, ClassObject classObject) {
		CompilationUnitCache.getInstance().clearCache();
		if(ASTReader.getSystemObject() != null && project.equals(ASTReader.getExaminedProject())) {
			new ASTReader(project, ASTReader.getSystemObject(), null);
		}
...
//		}
	...
	public static Set<TypeCheckEliminationGroup> getTypeCheckEliminationRefactoringOpportunities(IJavaProject project, ClassObject classObject) {
		CompilationUnitCache.getInstance().clearCache();
		if(ASTReader.getSystemObject() != null && project.equals(ASTReader.getExaminedProject())) {
			new ASTReader(project, ASTReader.getSystemObject(), null);
		}
...
//		classObjectsToBeExamined.addAll(systemObject.getClassObjects());
	...
	public static Set<ASTSliceGroup> getExtractMethodRefactoringOpportunities(IJavaProject project, ClassObject classObjectFromDB) {
		CompilationUnitCache.getInstance().clearCache();
		if(ASTReader.getSystemObject() != null && project.equals(ASTReader.getExaminedProject())) {
			new ASTReader(project, ASTReader.getSystemObject(), null);
		}
...
//		classObjectsToBeExamined.addAll(systemObject.getClassObjects());
		...
		classObjectsToBeExamined.add(classObjectFromDB);
